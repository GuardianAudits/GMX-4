...
describe.only("Guardian", () => {
  ...
  it("CRITICAL:Position with size but 0 collateral", async () => {
    ...
    // We break the market token balance validation and are unable to claim. If more WNT was sent to the market token,
    // the user would eat into another user's value.
    await expect(
